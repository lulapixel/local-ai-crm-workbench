...
import { safeInstagramProfileUrl } from "@/lib/safeExternalUrl"
...
function LinhaFollowup({
  ...
  const whatsappUrl =
    tarefa.canal === "maps"
      ? linkWhatsappComMensagem(tarefa.whatsapp_link, tarefa.mensagem)
      : undefined
  const instagramUrl =
    tarefa.canal === "instagram" ? safeInstagramProfileUrl(tarefa.username) : undefined
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-border bg-card p-3 shadow-sm">
      ...
      <div className="flex flex-wrap gap-1.5">
        ...
        {tarefa.canal === "instagram" && instagramUrl && (
          <>
            {tarefa.mensagem && (
              <Button
                size="sm"
...
function LinhaLeadQuente({
  ...
  const whatsappUrl = linkWhatsappComMensagem(lead.whatsapp_link, lead.mensagem)
