...
def _salvar(caminho_saida: Path, post_url, perfis: list[dict]) -> None:
    ...
    try:
        # O checkpoint precisa aparecer inteiro ou não aparecer: uma queda de
        # luz durante write_text não pode destruir o último progresso válido.
        ...
        if caminho_temporario is not None:
            try:
                ...
                # A falha original (se houver) é mais importante que uma
                # limpeza best-effort do temporário.
                pass
