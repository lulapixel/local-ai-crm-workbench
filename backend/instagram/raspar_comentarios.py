...
def _salvar_json_atomico(caminho_saida: Path, resultado: dict) -> None:
    """Grava uma captura completa sem truncar a versão anterior em falhas."""
...
def raspar_comentarios(url: str) -> Path:
    ...
    _salvar_json_atomico(caminho_saida, resultado)
