...
class TestRodarScraperComProgresso:
    ...
    def test_timeout_funciona_mesmo_sem_stdout(self):
        # Antes do leitor assíncrono, o supervisor ficava preso no readline até
        # o processo silencioso terminar e não aplicava o prazo configurado.
        comando = [
            sys.executable,
            "-c",
